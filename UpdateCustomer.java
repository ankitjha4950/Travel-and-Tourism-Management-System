...
public  class UpdateCustomer extends JFrame implements ActionListener{
    ...
    JComboBox comboid;
    JTextField tfnumber,tfcountry,tfaddress,tfphoneno,tfemail,tfphn,tfid,tfgender;
    ...
    JButton add,back;
     ...
     UpdateCustomer(String username){
        ...
        try{
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from account where username = 'ankit' ");
            while(rs.next()){
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if( ae.getSource() == add){
            ...
            try{
                Conn c = new Conn();
                String query = "insert into customer  values (  '"+username+"', '"+id+"', '"+number+"', '"+name+"', '"+gender+"',  '"+email+"', '"+country+"', '"+address+"',  '"+phoneno+"' )" ;
