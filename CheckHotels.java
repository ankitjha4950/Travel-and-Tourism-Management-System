...
public class CheckHotels extends JFrame implements Runnable
{
    ...
    public void run(){
        String[] text = new String[]{"JM Marriott Hotel","Madarin Oriental Hotel"," Four Seasons Hotel","Raddisson Blue Hotel","Classsio Hotel","the Bay Club Hotel","The Taj Hotel","The Leela Palace"," The Paradise","The Crown Palace"};
